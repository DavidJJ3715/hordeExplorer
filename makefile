...
dependencies = makefile main.cpp func.h player.h enemy.h
...
HordeExplorer: $(dependencies)
	...
	powershell move hordeExplorer.exe C:\Users\david\Downloads\Code\Exports\hordeExplorer
